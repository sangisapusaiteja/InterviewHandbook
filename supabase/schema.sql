-- ============================================================
-- INTERVIEW HANDBOOK â€” Database schema (Supabase PostgreSQL)
-- Tables for the interview handbook app only.
-- Shares the unified `users` table with Code Battle.
-- ============================================================

-- ------------------------------------------------------------------
-- users
-- The single identity table shared across apps. Password is bcrypt-hashed.
-- xp / level / elo / wins / losses are SERVER-WRITTEN ONLY.
-- ------------------------------------------------------------------
...
-- ------------------------------------------------------------------
-- user_topic_progress â€” topic completion tracking.
...
-- ------------------------------------------------------------------
-- user_preferences â€” theme, pinned topics, assistant state, etc.
-- ------------------------------------------------------------------
...
-- ------------------------------------------------------------------
-- user_progress_dashboard â€” aggregated view for progress page.
-- ------------------------------------------------------------------
...
-- ------------------------------------------------------------------
-- modules â€” learning path groupings within a category.
-- ------------------------------------------------------------------
...
-- ------------------------------------------------------------------
-- topics â€” main content (concept, code, metadata).
-- ------------------------------------------------------------------
