...
export function MobileBottomNav() {
  ...
  const isTopicPage = pathname.startsWith("/dsa") || pathname.startsWith("/html") || pathname.startsWith("/css") || pathname.startsWith("/javascript") || pathname.startsWith("/python") || pathname.startsWith("/postgresql") || pathname.startsWith("/system-design") || pathname.startsWith("/technical-questions");
